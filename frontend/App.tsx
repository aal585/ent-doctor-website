          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
              ...
              <address className="not-italic">
                ...
                <p>Dubai, UAE</p>
                <p>{t("contact.phone")}: <a href="tel:+97141234567" className="hover:text-primary">+971 4 123 4567</a></p>
                <p>{t("contact.email")}: <a href="mailto:info@drsultan.com" className="hover:text-primary">info@drsultan.com</a></p>
              </address>
            </div>
            <div>
            ...
            <div>
              ...
              <p><a href="tel:+97149876543" className="hover:text-primary">+971 4 987 6543</a></p>
            </div>
          </div>
